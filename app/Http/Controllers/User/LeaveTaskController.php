...
class LeaveTaskController extends Controller
{
    ...
    {
        $myFormMeninggalkanTugas = FormMeninggalkanTugas::where('id_user', auth()->user()->id)
                        ->orderBy('created_at', 'desc')
                        ->get();

        return view('user.form.leaveTask', [
            'title' => 'Meninggalkan Tugas',
            'section' => 'Form',
            'myFormMeninggalkanTugas' => $myFormMeninggalkanTugas,
            'active' => 'Meninggalkan Tugas',
        ]);
    }

    public function storeRequestLeaveTask (Request $request) {
        ...
        try{
            ...
            $FormMeninggalkanTugas = FormMeninggalkanTugas::create([
            ...
            return redirect('/requestFormLeaveTask')->with('insertSuccess', 'Request created successfully.');
