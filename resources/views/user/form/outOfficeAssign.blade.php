			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card">
					...
					<div class="card-body pb-10">
						<!--Begin::Table-->
						<form id="my-form" action="/storeRequestOutOfficeAssign" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
							@csrf
							<!--begin::Input group-->
							<div class="row">
								<!--begin::Input group-->
					...
					<div class="card-body pb-10">
						...
						<div class="table-responsive">
                            <table class="table table-row-bordered gy-5">
                                ...
                                <tbody>
                                    @foreach($myFormTgsKlrKantor as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
