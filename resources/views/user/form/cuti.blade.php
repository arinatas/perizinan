						...
						<form id="my-form" action="/storeRequestCuti" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
							...
							<div class="row">
								...
								<div style="display: none;">
                                    ...
                                    <input type="text" name="id_devisi" value="{{ auth()->user()->id_devisi }}">
                                    <input type="text" name="nama" value="{{ auth()->user()->nama }}">
                                    <input type="text" name="jabatan" value="{{ auth()->user()->jabatan }}">
                                    <input type="text" name="approve_atasan" value="0">
                                    <input type="text" name="approve_sdm" value="0">
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="d-flex flex-column mb-7 col-lg-4">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" required type="date" placeholder="Select a date" name="tanggal_mulai" />
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="d-flex flex-column mb-7 col-lg-4">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" required type="date" placeholder="Select a date" name="tanggal_selesai" />
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="d-flex flex-column mb-7 col-lg-3">
									...
									<!--end::Label-->
                                    <select class="form-select form-select-solid" required data-control="select2" data-hide-search="true" data-placeholder="Pilih jenis cuti" name="jenis_cuti">
								...
								<div class="d-flex flex-column mb-7 col-lg-6">
									...
									<!--end::Label-->
                                        <input type="text" required class="form-control form-control-solid" placeholder="Alamat" name="alamat" />
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
								<div class="d-flex flex-column mb-7 col-lg-3">
				...
				<div class="card mt-10">
					...
					<div class="card-body pb-10">
						...
						<div class="table-responsive">
                            ...
                            {{-- <img src="storage\{{ $jurnal->file_bukti }}" class="img-fluid mx-auto d-block mt-10" alt="..."> --}}
                        </div>
						<!--end::Table-->
					</div>
					<!--end::Card body-->
