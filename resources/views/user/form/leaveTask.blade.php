			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card">
					...
					<div class="card-body pb-10">
						<!--Begin::Table-->
						<form id="my-form" action="/storeRequestLeaveTask" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
							@csrf
							<!--begin::Input group-->
							<div class="row">
								<!--begin::Input group-->
								...
								<div class="d-flex flex-column mb-7 col-lg-4">
                                    ...
                                    <select class="form-select form-select-solid" required data-control="select2" data-hide-search="true" data-placeholder="Pilih waktu" name="waktu">
										...
										<option value="09:00 - 11:00">Awal</option>
										<option value="15:00 - 17:00">Akhir</option>
									</select>
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
					...
					<div class="card-body pb-10">
						...
						<div class="table-responsive">
                            <table class="table table-row-bordered gy-5">
                                ...
                                <tbody>
                                    @foreach($myFormMeninggalkanTugas as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->tanggal }}</td>
                                            <td>{{ $item->waktu }}</td>
