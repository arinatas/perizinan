			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card">
					...
					<div class="card-body pb-10">
						<!--Begin::Table-->
						<form id="my-form" action="/storeRequestSakit" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
							@csrf
							<!--begin::Input group-->
							<div class="row">
								<!--begin::Input group-->
								...
								<div class="d-flex flex-column mb-7 col-lg-4">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" required type="date" placeholder="Select a date" id="tanggal_mulai" name="tanggal_mulai" />
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="d-flex flex-column mb-7 col-lg-4">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" required type="date" placeholder="Select a date" id="tanggal_selesai" name="tanggal_selesai" />
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="d-flex flex-column mb-7 col-lg-12">
									...
									<textarea class="form-control form-control-solid" required rows="3" name="keterangan" placeholder="Deskripsi keterangan"></textarea>
								</div>
								<!--end::Input group-->
							</div>
							<!--end::Input group-->
