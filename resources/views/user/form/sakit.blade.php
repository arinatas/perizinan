							...
							<div class="row">
								...
								<div class="d-flex flex-column mb-7 col-lg-4">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" required type="date" placeholder="Select a date" id="tanggal" name="tanggal" />
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered mw-850px">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body scroll-y mx-xl-8">
                                                                ...
                                                                <img src="uploads\{{ $item->bukti_pendukung }}" class="img-fluid mx-auto d-block mt-10" alt="...">
