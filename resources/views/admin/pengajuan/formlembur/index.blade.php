                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <div class="card-px mt-10">
                                            <form action="{{ route('formlembur') }}" method="GET">
                                                <div class="row mb-3">
                                                    <div class="col-md-3">
                                        ...
                                        <table class="table table-striped gy-7 gs-7" id="sortableTable">
                                            <thead>
                                                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                                    ...
                                                    <th class="min-w-50px" data-type="string" onclick="sortTable(2)">Jabatan ▲</th>
                                                    <th class="min-w-100px" data-type="string" onclick="sortTable(3)">Tanggal ▲</th>
                                                    <th class="min-w-50px" data-type="string" onclick="sortTable(4)">Jam Mulai ▲</th>
                                                    <th class="min-w-50px" data-type="string" onclick="sortTable(5)">Jam Selesai ▲</th>
                                                    <th class="min-w-50px" data-type="string" onclick="sortTable(6)">Approve Atasan ▲</th>
                                                    <th class="min-w-50px" data-type="string" onclick="sortTable(7)">Approve SDM ▲</th>
