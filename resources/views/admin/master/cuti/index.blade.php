                ...
                <div class="card">
                    ...
                    <div class="card-body pb-5">
                        ...
                        <div class="card-px pt-10 d-flex justify-content-between">
                            ...
                            <div class="d-inline">
                                <a href="#" class="btn btn-sm btn-primary fs-6" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_new_jeniscuti">Tambah</a>
                            </div>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        ...
                        <div class="card-body pb-1">
                            <form action="{{ route('cuti') }}" method="GET" class="mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="year" class="form-label">Filter by Tahun:</label>
                                        <select name="year" id="year" class="form-select">
                                            <option value="" {{ empty(request('year')) ? 'selected' : '' }}>Silahkan Pilih Tahun</option>
                                            @foreach ($uniqueYears as $uniqueYear)
                                                <option value="{{ $uniqueYear }}" {{ request('year') == $uniqueYear ? 'selected' : '' }}>
                                                    {{ $uniqueYear }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                                ...
                                <div
                                    ...
                                    <div class="mb-3 mb-md-0 fw-bold">
                                        <h4 class="text-gray-900 fw-bolder">Silakan filter terlebih dahulu berdasarkan tahun
                                        </h4>
                                        <div class="fs-6 text-gray-700 pe-7">Pilih tahun pada formulir di atas untuk melihat
                                            data.</div>
                                    </div>
                                    <!--end::Content-->
                                </div>
                            ...
                            <table class="table table-striped gy-7 gs-7">
                                <thead>
                                    <tr
                                        ...
                                        <th class="min-w-100px">Jumlah Cuti</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('edit.cuti', $item->id ) }}"
                                                class="btn btn-sm btn-primary btn-action" data-toggle="tooltip"
                                                title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                            <form id="form-delete"
                                                action="{{ route('destroy.cuti', $item->id ) }}" method="POST"
                                                class="d-inline-block">
                                                @csrf
                                                @method('DELETE')
                                                <button id="submit-btn" type="submit" data-toggle="tooltip"
                                                    data-original-title="Hapus bagian"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form action="{{ route('insert.cuti') }}" method="POST">
                                                @csrf
                                                <!--begin::Input group-->
                                                ...
                                                <div class="d-flex flex-column mb-7 fv-row">
                                                    ...
                                                    <!--end::Label-->
                                                    <input class="form-control form-control-solid" type="text" name="jumlah_cuti" required value=""/>
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Actions-->
