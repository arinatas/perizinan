			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card">
					...
					<div class="card-body pb-5">
						...
						<!--begin::Table-->
                        <div class="mt-15">
                            <form action="{{ route('update.jeniscuti', $jeniscuti->id ) }}" method="POST">
                                @csrf
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Nama Cuti</label>
                                    <input type="text" value="{{$jeniscuti->nama_cuti}}" class="form-control form-control-solid" required name="nama_cuti"/>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <!--begin::Actions-->
                                    <a href="{{ route('jeniscuti') }}" class="btn btn-secondary">
